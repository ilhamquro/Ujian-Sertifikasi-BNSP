...
{
    // Buat Variabel yg isinya Dinamis
    protected $userid;
    // Ini buat ngasi inputan login biar bisa login pake username atau email
    protected function prepareForValidation(): void
    {
        // if untuk nginputin email
        if (filter_var($this->input('usermail'),FILTER_VALIDATE_EMAIL)) {
            $this->userid = 'email';
        }
        // else untuk nginputin username 
        else {
