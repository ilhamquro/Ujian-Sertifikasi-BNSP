        ...
        <div id="auth-left">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="text" id="name" class="form-control form-control-xl" name="name" placeholder="Name">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    ...
                    name="password_confirmation"  class="form-control form-control-xl" placeholder="Confirm Password">
                    <div class="form-control-icon">
                        <i class="bi bi-shield-lock"></i>
                    </div>
                </div>
