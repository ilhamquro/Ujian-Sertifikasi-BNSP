            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="{{ url('/dashboard') }}"><img src="{{ asset('dist') }}/assets/compiled/svg/logo.svg"
                                    alt="Logo" srcset=""></a>
                        </div>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                {{-- <li class="submenu-item  ">
                                    <a href="{{ url('kategori') }}" class="submenu-link">Manage Kategories</a>
                                </li>
                                <li class="submenu-item  ">
                                    <a href="{{ url('buku') }}" class="submenu-link">Manage Books</a>
                                </li> --}}
                                
                                <li class="submenu-item  ">
                                    <a href="{{ url('peserta') }}" class="submenu-link">Manage Peserta</a>
                                </li>
                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">90.000</h6>
                                    </div>
                                </div> 
                            </div>
                        </div>
                        ...
                        <div class="card"> 
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Jumlah Pengajar</h6>
                                        {{-- <h6 class="font-extrabold mb-0">{{$peserta->count()}}</h6> --}}
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Kursus</h6>
